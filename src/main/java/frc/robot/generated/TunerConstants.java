...
public class TunerConstants {
    ...
    private static final Current kSlipCurrent = Amps.of(100); //was 120
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(new CurrentLimitsConfigs()
            ...
            .withSupplyCurrentLimit(40) //not present before
            .withSupplyCurrentLimitEnable(true)   //not present before
        );
        //.withClosedLoopRamps(new ClosedLoopRampsConfigs().withVoltageClosedLoopRampPeriod(0.01));// can BE 0.025
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Swerve azimuth does not require much torque output, so we can set a relatively low
                // stator current limit to help avoid brownouts without impacting performance.
                .withStatorCurrentLimit(Amps.of(40)) // was 60
                .withStatorCurrentLimitEnable(true)
                .withSupplyCurrentLimit(30) // not present before
    ...
    public static final CANBus kCANBus = new CANBus("4564_Canivore_01", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.1044921875);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.2841796875);
